...
// CompleteTerraformBridgeProvider returns a complete Pulumi provider with 100% feature coverage
func CompleteTerraformBridgeProvider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Description: "A Pulumi package for creating and managing Aviatrix cloud resources with 100% feature coverage.",
