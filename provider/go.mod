module github.com/AviatrixSystems/pulumi-avx-test-dummy/provider

go 1.23.11

toolchain go1.24.4

replace github.com/AviatrixSystems/terraform-provider-aviatrix/v3 => ../terraform-provider-aviatrix

require (
	github.com/AviatrixSystems/terraform-provider-aviatrix/v3 v3.2.2
