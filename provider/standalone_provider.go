...
// StandaloneProvider represents a standalone Aviatrix provider
...
// NewStandaloneProvider creates a new standalone provider
...
func (p *StandaloneProvider) GetResources() map[string]string {
	return p.Resources
}

// GetDataSources returns all available data sources
func (p *StandaloneProvider) GetDataSources() map[string]string {
	return p.DataSources
}

// GetResourceCount returns the number of resources
func (p *StandaloneProvider) GetResourceCount() int {
	return len(p.Resources)
}

// GetDataSourceCount returns the number of data sources
func (p *StandaloneProvider) GetDataSourceCount() int {
	return len(p.DataSources)
}

// ValidateConfig validates the provider configuration
func (p *StandaloneProvider) ValidateConfig(config map[string]interface{}) error {
...
func (p *StandaloneProvider) PrintInfo() {
...
// Main function for standalone provider
func Main() {
	if len(os.Args) < 2 {
