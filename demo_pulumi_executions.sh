...
# Comprehensive Pulumi Execution Demo for Aviatrix Provider
set -e

echo "🚀 Pulumi Aviatrix Provider - Live Execution Demos"
echo "================================================="
...
if command -v pulumi >/dev/null 2>&1; then
    echo "✅ Pulumi CLI: $(pulumi version)"
else
...
echo -e "\n${YELLOW}🚀 Starting Pulumi Execution Demos...${NC}"

# Go Pulumi Demo
echo -e "\n${PURPLE}🔵 Go Pulumi Demo${NC}"
run_demo "Go Pulumi Program" "cd pulumi-demos/go && go mod tidy && pulumi preview --non-interactive" "pulumi-demos/go"

# Python Pulumi Demo
echo -e "\n${PURPLE}🐍 Python Pulumi Demo${NC}"
run_demo "Python Pulumi Program" "cd pulumi-demos/python && pip install -r requirements.txt && pulumi preview --non-interactive" "pulumi-demos/python"

# C# Pulumi Demo
echo -e "\n${PURPLE}🔷 C# Pulumi Demo${NC}"
run_demo "C# Pulumi Program" "cd pulumi-demos/csharp && dotnet restore && pulumi preview --non-interactive" "pulumi-demos/csharp"

# Java Pulumi Demo
echo -e "\n${PURPLE}☕ Java Pulumi Demo${NC}"
run_demo "Java Pulumi Program" "cd pulumi-demos/java && mvn clean compile && pulumi preview --non-interactive" "pulumi-demos/java"

# TypeScript Pulumi Demo
echo -e "\n${PURPLE}📘 TypeScript Pulumi Demo${NC}"
run_demo "TypeScript Pulumi Program" "cd pulumi-demos/typescript && npm install && npm run build && pulumi preview --non-interactive" "pulumi-demos/typescript"
...
if [ $DEMOS_FAILED -eq 0 ]; then
    ...
    echo -e "${GREEN}✅ Pulumi preview works for all languages${NC}"
