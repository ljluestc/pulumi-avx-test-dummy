...
# Simple Pulumi Execution Demo for Aviatrix Provider
set -e

echo "🚀 Pulumi Aviatrix Provider - Simple Execution Demos"
echo "=================================================="
...
echo -e "\n${YELLOW}🚀 Starting Simple Pulumi Demos...${NC}"

# Go Pulumi Demo
echo -e "\n${PURPLE}🔵 Go Pulumi Demo${NC}"
run_demo "Go Pulumi Program" "cd pulumi-demos/go && go mod tidy && go run main.go && cd ../.." "pulumi-demos/go"

# Python Pulumi Demo
echo -e "\n${PURPLE}🐍 Python Pulumi Demo${NC}"
run_demo "Python Pulumi Program" "cd pulumi-demos/python && python3 __main__.py && cd ../.." "pulumi-demos/python"

# C# Pulumi Demo
echo -e "\n${PURPLE}🔷 C# Pulumi Demo${NC}"
run_demo "C# Pulumi Program" "cd pulumi-demos/csharp && dotnet run && cd ../.." "pulumi-demos/csharp"

# Java Pulumi Demo
echo -e "\n${PURPLE}☕ Java Pulumi Demo${NC}"
run_demo "Java Pulumi Program" "cd pulumi-demos/java && mvn clean compile && mvn exec:java && cd ../.." "pulumi-demos/java"

# TypeScript Pulumi Demo
echo -e "\n${PURPLE}📘 TypeScript Pulumi Demo${NC}"
run_demo "TypeScript Pulumi Program" "cd pulumi-demos/typescript && npm install && npm run build && npm start && cd ../.." "pulumi-demos/typescript"
